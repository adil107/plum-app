    ...
    return (
        <div className="w-full mb-20" id={'Testimonial_Section'}>
            <div className="Award_Winning  py-14 relative text-center">
                <h1 className="text-white text-2xl">What they say about award-winning sound.</h1>
            </div>

            <div className="Testimonials_Card_Wrapper text-center py-20 md:max-w-7xl px-5 sm:px-16 grid grid-cols-2 gap-y-5 lg:gap-10">
                {testimonial?.map((ele) => (
                    <div key={ele.id} className="border col-span-2 lg:col-span-1 py-10 px-4 flex flex-col items-center">
